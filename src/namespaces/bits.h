...
static inline int BITScanForward(u64 bb) {
    ...
    static constexpr int lsb_64_table[64] = {63, 30, 3,  32, 59, 14, 11, 33, 60, 24, 50, 9,  55, 19, 21, 34, 61, 29, 2,  53, 51, 23,
...
static inline int BITScanReverse(u64 bb) {
    static constexpr int index64[64] = {0,  47, 1,  56, 48, 27, 2,  60, 57, 49, 41, 37, 28, 16, 3,  61, 54, 58, 35, 52, 50, 42,
...
template <uchar side, int shift> static u64 shiftForward(const u64 bits) {
...
#define BITScanForwardUnset(bits) BITScanForward(~(bits))
