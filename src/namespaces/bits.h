...
static inline int BITScanForward(u64 bb) {
  ...
  static constexpr int lsb_64_table[64] = {63, 30, 3,  32, 59, 14, 11, 33, 60, 24, 50, 9,  55, 19, 21, 34,
...
static inline int BITScanReverse(u64 bb) {
  static constexpr int index64[64] = {0,  47, 1,  56, 48, 27, 2,  60, 57, 49, 41, 37, 28, 16, 3,  61,
...
static inline int BITScanForwardUnset(const u64 bb) { return BITScanForward(~bb); }
}  // namespace _def
