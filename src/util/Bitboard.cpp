...
void Bitboard::popolateDiagonal() {
    for (uchar pos = 0; pos < 64; pos++) {
        vector<u64> combinationsDiagonal = getCombination(DIAGONAL[pos]);
...
void Bitboard::popolateColumn() {
    for (uchar pos = 0; pos < 64; pos++) {
        vector<u64> combinationsColumn = getCombination(FILE_[pos]);
...
void Bitboard::popolateRank() {
    for (uchar pos = 0; pos < 64; pos++) {
        vector<u64> combinationsRank = getCombination(RANK[pos]);
...
void Bitboard::popolateAntiDiagonal() {
    for (uchar pos = 0; pos < 64; pos++) {
        vector<u64> combinationsAntiDiagonal = getCombination(ANTIDIAGONAL[pos]);
