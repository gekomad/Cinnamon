            ...
            for (int dir = 0; dir < 2; dir++) {
                ...
                *param.second.ref = newValue;
                ...
                while (true) {
                    ...
                    cout << param.first << " try value: " << newValue << "\terror: " << currentError << "\tbestError: " << bestError;
                ...
                *param.second.ref = oldValue;
                if (bestValue >= 0) {
                    cout << "\n** Improved. ** bestError: " << bestError << " bestValue " << bestValue << " was " << param.second.startValue << flush;
