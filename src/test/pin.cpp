...
//    friends = searchManager.getBitmap(0, BLACK);
//    enemies = searchManager.getBitmap(0, WHITE);
//    kingPosition = BITScanForward(searchManager.getThread(0).getChessboard().bit[KING_BLACK]);
//    p = searchManager.getPinned<BLACK>(enemies | friends, friends, kingPosition);
...
//    kingPosition = BITScanForward(searchManager.getThread(0).getChessboard().bit[KING_WHITE]);
