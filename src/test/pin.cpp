...
//    p = searchManager.getPin<BLACK>(enemies | friends, friends, kingPosition);
//    EXPECT_EQ(0, p);
//
...
//    kingPosition = BITScanForward(searchManager.getThread(0).getChessboard()[KING_WHITE]);
//    p = searchManager.getPin<WHITE>(enemies | friends, friends, kingPosition);
