...
try_all_castle ( const int SIDE ) {
  ...
  if ( SIDE == WHITE ) {
    if ( !CASTLE_DONE[WHITE] && !CASTLE_NOT_POSSIBLE[WHITE]
	 ...
	 && get_piece_at ( 1, TABLOG_1 ) == SQUARE_FREE && get_piece_at ( 1, TABLOG_2 ) == SQUARE_FREE && get_piece_at ( 0, TABLOG_1 ) == SQUARE_FREE && get_piece_at ( 0, TABLOG_2 ) == SQUARE_FREE && get_piece_at ( 1, TABLOG_0 ) == TOWER_WHITE && get_piece_at ( 1, TABLOG_3 ) == KING_WHITE && !attack_square ( SIDE, 1 ) && !attack_square ( SIDE, 2 )
	 && !attack_square ( SIDE, 3 ) )
      pushmove ( CASTLE, KINGSIDE, WHITE, -1 );

    if ( !CASTLE_DONE[WHITE] && !CASTLE_NOT_POSSIBLE[WHITE]
	 && !CASTLE_NOT_POSSIBLE_QUEENSIDE[WHITE]
	 && get_piece_at ( 1, TABLOG_5 ) == SQUARE_FREE && get_piece_at ( 1, TABLOG_6 ) == SQUARE_FREE && get_piece_at ( 0, TABLOG_5 ) == SQUARE_FREE && get_piece_at ( 0, TABLOG_6 ) == SQUARE_FREE && get_piece_at ( 1, TABLOG_4 ) == SQUARE_FREE && get_piece_at ( 0, TABLOG_4 ) == SQUARE_FREE && get_piece_at ( 1, TABLOG_7 ) == TOWER_WHITE && get_piece_at ( 1, TABLOG_3 ) == KING_WHITE && !attack_square ( SIDE, 3 ) && !attack_square ( SIDE, 4 )
    ...
    if ( !CASTLE_DONE[BLACK] && !CASTLE_NOT_POSSIBLE[BLACK]
	 ...
	 && get_piece_at ( 0, TABLOG_57 ) == SQUARE_FREE && get_piece_at ( 0, TABLOG_58 ) == SQUARE_FREE && get_piece_at ( 1, TABLOG_57 ) == SQUARE_FREE && get_piece_at ( 1, TABLOG_58 ) == SQUARE_FREE && get_piece_at ( 0, TABLOG_56 ) == TOWER_BLACK && get_piece_at ( 0, TABLOG_59 ) == KING_BLACK && !attack_square ( SIDE, 57 ) && !attack_square ( SIDE, 58 )
	 && !attack_square ( SIDE, 59 ) )
      pushmove ( CASTLE, KINGSIDE, BLACK, SIDE );

    if ( !CASTLE_DONE[BLACK] && !CASTLE_NOT_POSSIBLE[BLACK]
	 && !CASTLE_NOT_POSSIBLE_QUEENSIDE[BLACK]
	 && get_piece_at ( 0, TABLOG_60 ) == SQUARE_FREE && get_piece_at ( 0, TABLOG_61 ) == SQUARE_FREE && get_piece_at ( 1, TABLOG_60 ) == SQUARE_FREE && get_piece_at ( 1, TABLOG_61 ) == SQUARE_FREE && get_piece_at ( 0, TABLOG_62 ) == SQUARE_FREE && get_piece_at ( 1, TABLOG_62 ) == SQUARE_FREE && get_piece_at ( 0, TABLOG_63 ) == TOWER_BLACK && get_piece_at ( 0, TABLOG_59 ) == KING_BLACK && !attack_square ( SIDE, 59 ) && !attack_square ( SIDE, 60 )
