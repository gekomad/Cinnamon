...
int
Search::search ( int depth, int alpha, int beta, _TpvLine * pline, int *mateIn ) {
...
template < int side > int
Search::search ( int depth, int alpha, int beta, _TpvLine * pline, int N_PIECE, int *mateIn ) {
