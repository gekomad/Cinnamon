 ...
 public:
  ...
  private:
      ...
      constexpr static int MateTable[64] = {
              ...
              30, 20, 20, 30, 50, 70, 70, 50, 30, 20, 20, 30, 50, 70, 80, 60, 40, 30, 30, 40, 60, 80, 90, 70, 60, 50,
  50, 60, 70, 90, 100, 90, 80, 70, 70, 80, 90, 100,};
      ...
      static int KRKP(int tempo, int winnerKingPos, int loserKingPos, int rookPos, int pawnPos) {
          ...
          if (((loserSide == BLACK && RANK_AT[loserKingPos] <= 2) || (loserSide == WHITE && RANK_AT[loserKingPos] >= 5))
              ...
              ((loserSide == BLACK && RANK_AT[winnerKingPos] >= 3) || (loserSide == WHITE && RANK_AT[winnerKingPos] <=
  4))
