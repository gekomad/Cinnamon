...
private:
    ...
    const int DECODE_PIECE[13] =
        {tb_PAWN, tb_PAWN, tb_ROOK, tb_ROOK, tb_BISHOP, tb_BISHOP, tb_KNIGHT, tb_KNIGHT, tb_KING, tb_KING, tb_QUEEN,
         tb_QUEEN, tb_NOPIECE};
    ...
    const int DECODE_POSITION[64] =
        {tb_H1, tb_G1, tb_F1, tb_E1, tb_D1, tb_C1, tb_B1, tb_A1, tb_H2, tb_G2, tb_F2, tb_E2, tb_D2, tb_C2, tb_B2, tb_A2,
         ...
         tb_H7, tb_G7, tb_F7, tb_E7, tb_D7, tb_C7, tb_B7, tb_A7, tb_H8, tb_G8, tb_F8, tb_E8, tb_D8, tb_C8, tb_B8,
         tb_A8,};

    int extractDtm(const unsigned stm1,
                   const bool doPrint,
